...
#define LIBEXACTREAL_ASSERT_ARGUMENT_(CONDITION) LIBEXACTREAL_CHECK_ARGUMENT_(LIBEXACTREAL_ASSERT_CONDITION(CONDITION))
#define LIBEXACTREAL_ASSERT_ARGUMENT(CONDITION, MESSAGE) LIBEXACTREAL_CHECK_ARGUMENT(LIBEXACTREAL_ASSERT_CONDITION(CONDITION), MESSAGE)
